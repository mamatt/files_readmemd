...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('readmeMD-appearance-txt').onclick = function (Event) {
    ...
    _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('apps/files_readmemd/config'), params, {
      headers: {
  ...
  [].forEach.call(els, el => {
    el.onclick = function (Event) {
      ...
      const zone = Event.target.dataset.zone; // console.log("tests" + Event.target)

      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.delete(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('apps/files_readmemd/config/filenames/' + zone + '/' + fn.replace('?', '%3F'))).then(function (data) {
        const parentElement = Event.target.parentNode;
        parentElement.parentNode.removeChild(parentElement); // $(self).parent().remove()
      });
    };
  }); // ADD
  ...
  document.getElementById('readmeMD-filelist_submit-footer').onclick = function (Event) {
    ...
    const zone = 'footer';
    _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('apps/files_readmemd/config/filenames/' + zone + '/' + fn.replace('?', '%3F'))).then(function (data) {
      document.getElementById('readmeMD-filelist_footer').insertAdjacentHTML('beforeend', '<li class="readmeMD-filelist" id="readmeMD-filelist-' + fn + '">' + '<a data-zone="footer" data-filename="' + fn + '" class="readmeMD-filelist_delete icon-inline icon icon-delete"></a>' + fn + '</li>');
    });
  };
  ...
  document.getElementById('readmeMD-filelist_submit-header').onclick = function (Event) {
    ...
    const zone = 'header';
    _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('apps/files_readmemd/config/filenames/' + zone + '/' + fn.replace('?', '%3F'))).then(function (data) {
      document.getElementById('readmeMD-filelist_header').insertAdjacentHTML('beforeend', '<li class="readmeMD-filelist" id="readmeMD-filelist-' + fn + '">' + '<a data-zone="header" data-filename="' + fn + '" class="readmeMD-filelist_delete icon-inline icon icon-delete"></a>' + fn + '</li>');
    });
  };
});
